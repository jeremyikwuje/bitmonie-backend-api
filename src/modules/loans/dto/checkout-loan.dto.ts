...
export class CheckoutLoanDto {
  ...
  @ApiProperty({
    ...
    description:
      ...
      'amount-to-receive (net of origination), and the daily interest + custody rates that accrue ' +
      'until repayment. Must be true; rejected with 400 otherwise. Stamped on the Loan row as ' +
      'terms_accepted_at.',
  })
  @IsBoolean()
